...
from utils import project_root, model_path, load_model
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        predictor = self.predictor.predict_proba(data)
...
class Visualizations(CombinedComponent):
    # Set the `id` class attribute to "visualizations"
    id = "visualizations"   
